...
export interface MapViewProps extends ViewProps {
  ...
  accuracyRingEnabled?: boolean;

  /**
   * 精度圈填充颜色
   */

  accuracyRingFillColor?: string;

  /**
   * 精度圈外边缘线颜色
   */

  accuracyRingStokrColor?: string;

  /**
   * 精度圈外边缘线宽度
   */
  accuracyRingLineWidth?: number;
  ...
  */
   ...
   * @platform ios
   */
  pulseAnnimationEnable?: boolean;

  /**
   * @description 定位点背景色， 如果配置了自定义定位图片的话不生效
   * @platform ios
   */
  locationDotBgColor?: string;

  /**
   * @description 定位点填充色， 如果配置了自定义定位图片的话不生效
   * @platform ios
   */
  locationDotFillColor?: string;

  /**
   * @description 貌似没有用，原生sdk设置了不生效
   * @platform ios
   */
...
const name = 'AMapView';
const NativeMapViewOld = requireNativeComponent<MapViewProps>(name);
